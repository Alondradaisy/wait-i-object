...
myCodeImmersivesObj. cumulativeScore = myCodeImmersivesObj.cumulativeScore += myCodeImmersivesObj.currentScore; // 'currentScore' + 'cumulativeScore'
...
// Now push three strings into that array.
  me.address.push('2199 NW Everett St');
  me.address.push('Portland');
  me.address.push('OR');
...
const freeWillObject = {
  ...
  time: 11,
  hoursOfCodeImmersives: ['7', '8', '9', '10', '11', '12'] 
  'login token' : 'ajkbkjwebgk' // this is what we added for the stretch goal
};
